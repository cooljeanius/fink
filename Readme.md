...
Please read the instructions carefully and do NOT be surprised if something does NOT work as expected. 
 ...
 * Development tools. For 10.6, you should install Xcode 3.2.6, which can
   be downloaded from connect.apple.com after registering. For 10.7-10.9,
   ...
   this command to update the tools, especially if you are having build
   problems.

   If you are doing a manual download, make sure that the tools you install
...
* Patience. Compiling several big packages takes time. I am talking hours or even days here.
...
Further Questions?
--------------------
If the documentation included here does NOT answer your question, stroll over to the Fink website at [http://www.finkproject.org/](http://www.finkproject.org/) and check out the Help page there: [http://www.finkproject.org/help/](http://www.finkproject.org/help/). 
It will point you at the other documentation that is available and sources for support if you need it.

If you would like to contribute to Fink, the Help page mentioned above also has a list of things you can do, like testing or creating packages.



Staying Informed
------------------
The website for the project is at [http://www.finkproject.org/](http://www.finkproject.org/).
